    ...
    <div className="mb-10">
      ...
      <div className="flex flex-wrap gap-3">
        {tools.map((tool, index) => (
          <div 
            key={index} 
            className="px-4 py-2.5 bg-white dark:bg-gray-700 shadow-sm hover:shadow-md rounded-lg text-sm flex items-center gap-2 border border-gray-100 dark:border-gray-600 dark:text-gray-200 transition-all duration-300 ease-in-out hover:-translate-y-1 cursor-pointer transform hover:scale-105 hover:border-gray-300 dark:hover:border-gray-500"
          >
